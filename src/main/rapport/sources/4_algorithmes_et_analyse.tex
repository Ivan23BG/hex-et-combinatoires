...
qui ne participeront pas au calcul du gain de la racine de l'arbre. Dit autrement, l'élagage alpha beta n'évalue pas des nœuds dont on peut penser, 
...
\begin{enumerate}
    ...
    la valeur actuelle du nœud MAX précédent. Celui-ci cherchant la valeur la plus grande possible, ne la choisira donc de toute façon pas.
    ...
    actuelle du nœud MAX précédent. Celui-ci cherchant la valeur la plus grande possible, ne la choisira donc de toute façon pas.
\end{enumerate}
