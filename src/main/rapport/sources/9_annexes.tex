...
\begin{itemize}
    ...
    déplacés.\\
    \begin{center}
        \includegraphics[scale=0.5]{root/chemin_gagnant_hex.png}    
    \end{center}
...
L'application s'ouvre sur une page home sur laquelle nous pouvons choisir le jeu auquel nous souhaitons jouer