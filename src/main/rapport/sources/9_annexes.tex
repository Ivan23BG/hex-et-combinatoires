...
une application web sur laquelle nous pourrons jouer au jeu du Hex et de l'Awalé.

Pour chaque jeux nous devons implémenter les règles officielles afin de jouer correctement 
aux deux jeux. De plus, nous voulons fournir une interface graphique agréable pour l'utilisateur. 
Cela comprends donc une page d'accueil intuitive ainsi que des plateaux de jeux faciles d'utilisations.

\underline{Description des jeux:}\\
\begin{itemize}
    \item Hex:
