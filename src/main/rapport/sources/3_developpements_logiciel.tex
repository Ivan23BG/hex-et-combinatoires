...
\begin{figure}[!htb]
    \centering
    \fbox{\includegraphics[width=.8\linewidth]{root/exemple_home}}
    \caption{Page Home du Hex}\label{fig:exemple_home}
\end{figure}
\begin{figure}[!htb]
    \centering
    \fbox{\includegraphics[width=.8\linewidth]{root/awale_board.png}}
    \caption{Page initiale de jeu de l'Awalé}\label{fig:awale_board}
\end{figure}
\begin{figure}[!htb]
    \centering
    \fbox{\includegraphics[width=.8\linewidth]{root/exemple_partie_hex}}
