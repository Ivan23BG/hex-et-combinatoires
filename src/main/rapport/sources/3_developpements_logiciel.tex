...
\begin{figure}[h]
    ...
    \caption{Page Home du Hex}\label{fig:exemple_home.png}

    \includegraphics[width=8cm]{root/awale_board.png}
    \caption{Page du jeu Awalé}\label{fig:awale_board.png}

    \includegraphics[width=8cm]{root/exemple_partie_hex.png}
    \caption{Page du jeu Hex}\label{fig:exemple_partie_hex.png}
\end{figure}
