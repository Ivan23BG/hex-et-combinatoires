...
class HexBoard:
    ...
    #give me a get_dijkstra_score that calculates the score of how many (shortest) path-steps remain to victory
    ...
    #give me an evaluating function that uses the git_score_dijkstra functoin
